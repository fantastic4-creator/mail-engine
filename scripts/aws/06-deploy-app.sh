...
# Delivery: set DELIVERY_MODE=smtp and supply SES or Postfix SMTP credentials
...
UNSUBSCRIBE_HMAC_SECRET="${UNSUBSCRIBE_HMAC_SECRET:-change-me-in-production}"
FROM_LOCAL_PART="${FROM_LOCAL_PART:-consult}"
...
MAIL_ENGINE_SMTP_HOST=${SMTP_HOST}
MAIL_ENGINE_SMTP_PORT=${SMTP_PORT}
MAIL_ENGINE_SMTP_AUTH_ENABLED=${SMTP_AUTH_ENABLED}
MAIL_ENGINE_SMTP_STARTTLS_ENABLED=${SMTP_STARTTLS_ENABLED}
MAIL_ENGINE_SMTP_USERNAME=${SMTP_USERNAME}
MAIL_ENGINE_SMTP_PASSWORD=${SMTP_PASSWORD}
MAIL_ENGINE_APP_BASE_URL=${APP_BASE_URL}
MAIL_ENGINE_UNSUBSCRIBE_HMAC_SECRET=${UNSUBSCRIBE_HMAC_SECRET}
MAIL_ENGINE_RUNTIME_FROM_LOCAL_PART=${FROM_LOCAL_PART}
